...
const s = /* #__PURE__ */ e('cp'),
    ...
    f = s('LS', () => ({ $el: 'div', attrs: { class: '$classes.LS' } })),
    g = s('canvasLS', () => ({
        $el: 'canvas',
        attrs: {
            id: '$: "canvas-ls-" + $id',
    ...
    m = s('hue', () => ({ $el: 'div', attrs: { class: '$classes.hue' } })),
    x = s('canvasHue', () => ({
        $el: 'canvas',
        attrs: {
            id: '$: "canvas-hue-" + $id',
...
export {
    ...
    g as canvasLS,
    C as canvasPreview,
    I as canvasSwatchPreview,
    H as colorInputGroup,
    L as controlAlpha,
    b as controlGroup,
    F as controlHue,
    y as controlLS,
