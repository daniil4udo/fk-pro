...
const s = /* #__PURE__ */ e('tf'),
    ...
    h = s('legend', () => ({ if: '$label', $el: 'legend' })),
    p = s('area', () => ({ $el: 'div', attrs: { id: '$id + "_area"' } })),
    f = s('source', () => ({
        $el: 'div',
        attrs: {
            id: '$id + "_source"',
    ...
    N = s('transferControls', () => ({
        $el: 'div',
        attrs: { id: '$id + "_transfer_controls"' },
    })),
    P = s('transferButtonForward', () => ({
    ...
    G = s('controlLabel', 'span'),
    J = s('sourceEmptyMessage', () => ({
        $el: 'li',
...
export {
    ...
    P as transferButtonForward,
    j as transferButtonForwardAll,
    N as transferControls,
    r as wrapper,
};
