...
function Zp(e, t) {
    if (((e.props.sourceListOrigin = !1), t)) {
        const o = Array.isArray(e.value) ? e.value.filter((e) => !n(e, t)) : [];
        return void e.input(o);
    }
...
function od(e, t, o, r) {
    ...
    if (gt(t) === Up)
        return void (
            null === (s = e.context) ||
            void 0 === s ||
            s.handlers.loadMore(!0)
        );
    const a = gt(t);
    (e.props.activeIndex = e.props.sourceOptions.findIndex((e) => n(gt(e), a))),
        e.props.transferOnSelect ? (o ? zp(e, a) : Zp(e, a)) : qp(e, t, o);
}
function nd(e, t) {
    const o = Qp(e, t);
