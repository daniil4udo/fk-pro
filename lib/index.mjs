...
const be = () => ({
    ...
    De = () => ({ $el: 'span', if: '$part.type === "literal" && $part.value' }),
    Ae = () => ({ $el: 'span', if: '$part.type === "char" && $part.value' }),
...
function Pe(e) {
    return {
        ...
        overlayLiteral: e('overlayLiteral', De),
        overlayChar: e('overlayChar', Ae),
...
function _t(e, t) {
    (e.props.allowAppendOptions = t), At(e);
}
const kt = /* #__PURE__ */ p({
        key: 'loading',
        type: 'state',
...
function So(e) {
    Lo(e),
        ...
        re && s(`${e.props.id}_selections`, Do.bind(null, e), e.props.__root);
}
function Lo(e) {
    e.isCreated &&
        (e.props.selections.length &&
    ...
    e.addProps(['behavior']),
        e.on('created', () => {
            'overscroll' === e.props.behavior &&
                ...
                (e.props.dropdownWrapperStyles = a(Ao)),
...
const sr = /* #__PURE__ */ Fe('rt'),
    ...
    jr = Ar('optionLoading', 'span'),
    zr = Ar('option', () => ({ $el: 'div', if: '$value !== undefined' })),
    Zr = /* #__PURE__ */ Re(Ar);
function Gr(e) {
    'option' !== e.props.selectionAppearance ||
        e.props.multiple ||
...
const Ci = {
        ...
        features: [
            b,
            /* #__PURE__ */ ao.bind(null, Di, qr, Ai),
            /* #__PURE__ */ g('select', 'select'),
            /* #__PURE__ */ g('close', 'close'),
            /* #__PURE__ */ g('selected', 'check'),
            /* #__PURE__ */ g('loader', 'spinner'),
                            ...
                            e.hook.input((t, o) => {
                                const n = (function (e, t) {
                                    ...
                                    const s = Ha(r, qi.get(e)),
                                        a = Al(r, e.props.allowIncomplete);
                                    if (t === o.value)
...
function ld(e) {
    e.on('created', () => {
        if (
            ('function' == typeof e.props.optionsLoader &&
                ((e.props.skipSetActiveValue = !0), At(e)),
            nd(e),
            e.props.disabled && (e.props.draggable = !1),
            re)
        ) {
...
const cd = /* #__PURE__ */ Fe('sl'),
    ...
    Dd = cd('fill', () => ({ $el: 'div', attrs: { style: '$fillStyles' } })),
    Ad = cd('linkedValues', () => ({ $el: 'div' })),
    Cd = cd('maxValue', () => ({
        $formkit: 'number',
        ...
        e.context &&
            ...
            (e.context.handlers.handleBeforeInput = (t) => {
                ...
                if (
                    ...
                    let y =
                        (null !== (l = t.target.selectionStart) && void 0 !== l
                            ? l
                            : 0) + (t.data ? 0 : -1);
                    t.target.selectionStart, t.data;
                    let x = h,
                        w = 1;
                    if (
